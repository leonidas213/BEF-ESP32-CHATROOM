...
/*
  ...
  Cihaz 2:Fulya
*/
const char* DeviceName = "Enes";     //cihazın uniqe adı
const char* ssid = "SUPERONLINE-WiFi_0321";               //wifi adın
const char* password = "lylNSngnNRSN";          //wifi şifresi
const char* mqtt_server = "broker.hivemq.com";   //Public mqtt brokerin ipsi
int mqtt_port = 1883;
//#-----------------------------------
String Subscribe1 = "BEFESP32/out_01";          //Berkantden gelen özel mesajlar
String Subscribe2 = "BEFESP32/out_21";          //Fulyaden gelen özel mesajlar
String Subscribe3 = "BEFESP32/out_0";           //Berkantden gelen mesajlar
String Subscribe4 = "BEFESP32/out_2";           //Fulyaden gelen mesajlar
//#-----------------------------------
//"1:merhaba " /sadece Berkant e gider
String Publish1 = "BEFESP32/out_10";           //Berkant e özel mesaj gönderilen adres
String WhisperTo1 = "berk:";                   //Özel mesaj göndermek için kullanılan özel kelime(?)

//"2:merhaba " /sadece Fulya ye gider
String Publish2 = "BEFESP32/out_12";           //Fulya ye özel mesaj gönderilen adres
String WhisperTo2 = "fulya:";                   //Özel mesaj göndermek için kullanılan özel kelime(?)

//"merhaba " /herkese mesaj gider
String Publish3 = "BEFESP32/out_1";            //Herkese Mesaj gönderme adresi
